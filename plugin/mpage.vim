...
"   call Decho("install ReSync on CursorMoved events")
   ...
   call SaveUserMaps("n","<PageDown>","","MPage")
   call SaveUserMaps("n","<PageUp>"  ,"","MPage")
   ...
   noremap <PageDown> :call <SID>MpageDown()<cr>
   noremap <PageUp>   :call <SID>MpageUp()<cr>
  endif
...
"   call Decho("turn MultiPager off in all windows in this tab")
   ...
   noautocmd windo if exists("w:mpage")|unlet w:mpage|endif
   if exists("#MPagerAutocmds")
	augroup MPagerAutocmds
	 au!
	augroup END
